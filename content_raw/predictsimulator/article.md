...
achievement.  E.g., if we assume that we are being simulated by a parent universe/existence, then that wold give us:
$$
1 + 0.4999\log_2(0.4999) + 0.5001\log_2(0.5001) = 0.000000028854
$$
gained information bits in that examples.
